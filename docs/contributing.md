...
Contributions are welcome. `go-ruby-saml/saml` is built to a small set of
...
The library is in [`github.com/go-ruby-saml/saml`](https://github.com/go-ruby-saml/saml).
This documentation site is in [`github.com/go-ruby-saml/docs`](https://github.com/go-ruby-saml/docs).
