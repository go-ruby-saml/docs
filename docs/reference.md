...
The public API lives at the module root (`github.com/go-ruby-saml/saml`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `saml`, while the surface follows
...
```go
import "github.com/go-ruby-saml/saml"
```
...
- **[pkg.go.dev/github.com/go-ruby-saml/saml](https://pkg.go.dev/github.com/go-ruby-saml/saml)**

The module's [README](https://github.com/go-ruby-saml/saml#readme) carries worked
