...
`go-ruby-saml/saml` reimplements Ruby's `saml` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-saml/saml` directly, with no Ruby runtime;
