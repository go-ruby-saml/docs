# go-ruby-saml documentation

**Pure-Go (no cgo), MRI-faithful port of Ruby's ruby-saml gem — the SAML 2.0 Service Provider toolkit exposed as OneLogin::RubySaml.**

`go-ruby-saml/saml` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `saml`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-saml/saml`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `saml`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-saml/saml
```
...
| Repo | What it is |
| --- | --- |
| [`saml`](https://github.com/go-ruby-saml/saml) | the library — Ruby's `saml` in pure Go |
| [`docs`](https://github.com/go-ruby-saml/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-saml.github.io`](https://github.com/go-ruby-saml/go-ruby-saml.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-saml/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-saml/saml](https://github.com/go-ruby-saml/saml).
